...
public class ResistorCalcs extends AppCompatActivity implements OnItemSelectedListener {
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (spinner.getId() == R.id.spinner1) {
            d1 = (int) parent.getItemAtPosition(position);
            spinner2.setEnabled(true);
        } else if (spinner.getId() == R.id.spinner2) {
            d2 = (int) parent.getItemAtPosition(position);
            spinner3.setEnabled(true);
        } else if (spinner.getId() == R.id.spinner3) {
            mnoz = (int) parent.getItemAtPosition(position);
            spinner4.setEnabled((true));
        } else if (spinner.getId() == R.id.spinner4) {
            toler = (int) parent.getItemAtPosition(position);
